...
This is the first version of the C128 cartridge and it has room for 1MB of ROM divided into 64 16kB banks. The cartridge format supports up to 4MB of ROM (256 blocks of 16kB) if more ROM chips are added.
